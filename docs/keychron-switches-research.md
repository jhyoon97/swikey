# Keychron 키보드 스위치 리서치

> **제조사:** Keychron
> **리서치 일자:** 2026-03-28
> **비고:** 중국 기반 키보드 브랜드. 자체 로우프로파일 메커니컬 스위치와 옵티컬 스위치 라인업 보유. K3, K5, K7 등 로우프로파일 키보드 시리즈로 유명. MX-호환 로우프로파일 메커니컬 스위치는 Gateron KS-33 호환. 옵티컬 스위치는 독자 규격.
...
|------|----------|--------|-----------|-----------|--------|----------|-------------|-------------|---------|---------|--------------|---------|-----------|------------|----------|----------|----------|------|
| Keychron Low Profile Red | - | Keychron | - | 리니어 | No | Yes | - | - | - | No | - | 3 | 3.1 | 1.3 | 45 | - | - | https://www.keychron.com/products/keychron-low-profile-switch-set |
| Keychron Low Profile Silent Red | - | Keychron | - | 리니어 | Yes | Yes | - | - | - | No | - | 3 | 2.7 | 1.4 | 40 | - | - | https://www.keychron.com/products/keychron-low-profile-switch-set |
| Keychron Low Profile Optical Red | - | Keychron | - | 리니어 | No | Yes | - | - | - | No | - | 없음 | 2.5 | 1.1 | 30 | - | - | https://www.keychron.com/products/low-profile-keychron-optical-switch-set-87-pcs |
| Keychron Low Profile Optical White | - | Keychron | - | 리니어 | No | Yes | - | - | - | No | - | 없음 | 2.5 | 1.1 | 30 | - | - | https://www.keychron.com/products/low-profile-keychron-optical-switch-set-87-pcs |
| Keychron Low Profile Optical Black | - | Keychron | - | 리니어 | No | Yes | - | - | - | No | - | 없음 | 2.5 | 1.1 | 60 | - | - | https://www.keychron.com/products/low-profile-keychron-optical-switch-set-87-pcs |
